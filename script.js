...
gameBoard.addEventListener("click", handleQuadrantClick);
...
function handleQuadrantClick(evt) {
...
//helper function to highlight a quadrant that is passed from quadrantIterator
